        ...
        <div className="mx-auto pt-3 md:flex md:justify-between md:items-center p-5 mb-10">
          ...
          <div className="md:w-3/6 pt-10 lg:px-10 mx-auto sm:px-5">
            ...
            <p className="leading-6 text-base">
              ...
              During this time, I have had opportunities to supervise the
              "Design and Development of a Tertiary Institution Campus
              Information System (2022)" and "The Development of a Virtual
              Medical Diagnostic System for Detecting and Analyzing Notifiable
              Diseases in Nigeria (2022)".
            </p>
            <br />
