...
function Events() {
  ...
  return (
    <div className="h-auto text-white">
      ...
      <div className="mx-auto my-10 text-gray-50 w-[80%] p-2 pt-28 rounded-lg">
        <Slide transitionDuration={800} {...properties} indicators={indicators}>
          {events.map((evt, index) => (
            <div
              ...
              className=" rounded-lg bg-[#000] bg-no-repeat bg-[length:100%_100%] bg-cover grid place-content-center w-full h-[80vh]"
            >
              <div className="p-5">
